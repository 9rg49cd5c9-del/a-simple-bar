...
fourth_of_july_drinks = [
    {
        "name": "Firework Fizz",
        "category": "Cocktails",
        "description": "A sparkling red-and-blue vodka lemonade that looks like fireworks in a glass.",
        "emoji": "🎆",
        "strength": "Medium",
        "vibe": "Party",
        "tags": ["Vodka", "Lemonade", "Blue Curaçao", "Sparkling"],
        ...
        "ingredients": [
            ...
            "Splash lemon-lime soda",
            "Ice",
            "Pop Rocks or sugar for rim",
        ],
        "recipe": [
            "Rim the glass with lemon and Pop Rocks or sugar.",
            "Fill the glass with ice.",
            "Add vodka, lemonade, and blue curaçao.",
            "Top with lemon-lime soda.",
            "Slowly pour grenadine down the side for a red firework effect.",
        ],
    },
    {
        "name": "Red White & Boozy",
        "category": "Cocktails",
        "description": "A creamy berry-and-coconut cocktail inspired by a red, white, and blue popsicle.",
        "emoji": "🇺🇸",
        "strength": "Medium",
        "vibe": "Pool Party",
        "tags": ["Coconut Rum", "Strawberry", "Blue Raspberry", "Creamy"],
        "flavor": "Sweet, Fruity",
        "ingredients": [
            "1 oz coconut rum",
            "1 oz vodka",
        ...
        "recipe": [
            "Blend coconut rum, vodka, strawberry purée, pineapple juice, cream of coconut, and ice.",
            "Pour into a clear glass.",
            "Drizzle blue raspberry syrup around the inside of the glass.",
    ...
    },
    {
        "name": "Sparkler Shot",
        "category": "Shots",
        "description": "A bright blue-and-silver party shot with citrus, vodka, and edible glitter.",
        "emoji": "✨",
        "strength": "Strong",
        "vibe": "Party",
        "tags": ["Vodka", "Blue Curaçao", "Citrus", "Glitter"],
        "flavor": "Sweet, Citrus",
        "ingredients": [
            "1/2 oz vodka",
            "1/2 oz blue curaçao",
            "Splash lemonade",
            "Pinch edible shimmer dust",
            "Ice",
        ],
        "recipe": [
            "Add vodka, blue curaçao, lemonade, shimmer dust, and ice to a shaker.",
            "Shake well.",
            "Strain into shot glasses.",
    ...
    {
        "name": "Cherry Bomb Pop",
        "category": "Camp Favorites",
        "description": "A playful cherry, blue raspberry, and lemonade drink inspired by a Bomb Pop.",
        "emoji": "🍒",
        "strength": "Medium",
        "vibe": "Backyard Party",
        "tags": ["Cherry", "Vodka", "Blue Raspberry", "Lemonade"],
        "flavor": "Sweet, Fruity",
        "ingredients": [
            ...
            "Ice",
            "Bomb Pop or gummy candy garnish",
        ],
        "recipe": [
            "Fill a tall glass with ice.",
            "Add grenadine first.",
            "Pour in cherry vodka and lemonade.",
            "Slowly float blue raspberry syrup over the top.",
            "Garnish with a Bomb Pop or patriotic gummy candy.",
        ],
    },
    {
        "name": "Rocket Pop Margarita",
        "category": "Margaritas",
        "description": "A frozen patriotic margarita inspired by the classic red, white, and blue ice pop.",
        "emoji": "🚀",
        "strength": "Strong",
        "vibe": "Summer Party",
        "tags": ["Tequila", "Strawberry", "Coconut", "Blue Raspberry"],
        "flavor": "Sweet, Fruity, Citrus",
        "ingredients": [
            "2 oz tequila",
            "1 oz orange liqueur",
            ...
            "Ice",
            "Patriotic sprinkles or Tajín for rim",
        ],
        "recipe": [
            "Blend tequila, orange liqueur, lime juice, strawberry purée, and ice.",
            "Pour into a rimmed margarita glass.",
            "Add a small layer of cream of coconut.",
            "Drizzle blue raspberry syrup over the top.",
            "Garnish with patriotic sprinkles.",
        ],
    },
    {
        "name": "Star Spangled Lemonade",
        "category": "Mocktails",
        "description": "A colorful kid-friendly lemonade with berry syrup, blue raspberry, and popping candy.",
        "emoji": "⭐",
        "strength": "None",
        "vibe": "Family Fun",
        "tags": ["Mocktail", "Lemonade", "Berry", "Blue Raspberry"],
        "flavor": "Sweet, Fruity, Citrus",
        "ingredients": [
            "3 oz lemonade",
            "1 oz strawberry syrup",
            "1 oz blue raspberry sports drink",
            "Ice",
            "Fresh strawberries and blueberries",
            "Pop Rocks or festive sprinkles for rim",
        ],
        "recipe": [
            "Rim the glass with lemonade and Pop Rocks or sprinkles.",
            "Fill the glass with ice.",
            "Add strawberry syrup.",
            "Pour in lemonade slowly.",
            "Float blue raspberry drink on top.",
